...
return <div name="experience" className="bg-gradient-to-b from-blue-800 to bg-blue-950 h-screen">
    
    <div className="max-w-screen-lg mx-auto p-4 flex flex-col justify-center w-full h-full text-white">


        <div>
            <p className="text-3xl font-bold border-b-4 border-amber-300 text-amber-300 p-2 inline">Experience</p>
            <p className="py-6">These are the softwares that I am proficient with.</p>
        </div>
        ...
        <div className="w-full grid grid-cols-2 sm:grid-cols-2 gap-8 text-center py-8 px-12 sm:px-0">

            {
                designsoftware.map(({id, src, title, style}) => (
                    <div key={id} className={`shadow-md hover:scale105 duration-500 py-2 rounded-lg ${style}`}>
