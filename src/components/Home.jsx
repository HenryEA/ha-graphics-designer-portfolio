...
const Home = () => {
  return (
  <div name= "home" className=" h-screen w-full bg-gradient-to-b from-blue-800 to bg-purple-900 "> 
    ...
    <div className=" max-w-screen-lg h-auto mx-auto flex flex-col items-center align-center justify-center px-4 md:flex-row md:justify-center md:pt-20 md:mt-20 sm:flex-col sm:h-auto lg:pt-20" >
         <div className="flex flex-col h-full md:pt-10 md:pl-10 ml-5">
           ...
           repeat={Infinity}
            ...
            kinds of flyers and illustrations as well as creating
            beautiful effects on images and designs. I love to work
            with Photoshop and CorelDraw.
            </p>
            <div>
                <Link to="portfolio" smooth duration={500} className=" group text-white w-fit px-6 py-3 my-1 flex items-center rounded-md bg-gradient-to-r from-amber-300 to-yellow-500 cursor-pointer">
                    Portfolio
