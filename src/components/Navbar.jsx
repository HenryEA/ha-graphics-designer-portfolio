...
const Navbar = () => {
  ...
  return <div className= 'top-0 mt-0 flex justify-between items-center w-full h-20 px-4 bg-gradient-to-b from-black to-gray-900 text-gray-200 fixed'>
    <div>
    ...
    {links.map(({id, link}) => (
        <li key = {id} className = "px-4 cursor-pointer capitalize font-medium text-gray-400 hover:text-gray-100 hover:scale-105 duration-200">
